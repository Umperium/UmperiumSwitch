	...
	<div class="card-body">
		...
		<div class="row"> 
			...
			<div class="col-sm-12">
				...
				<a href="<?php echo $link; ?>" <?php if($link=='') { ?> class="buy-btn" data-id="<?php echo $row['id']; ?>" data-price="<?php echo $price; ?>" data-toggle="modal" data-animation="bounce" data-target=".bs-buy" <?php } ?>><img src="<?php echo $row['image']; ?>" style="width:100%; "></a><br><br>
				<?php }  ?>
...
<?php echo $row['comment']; ?>
			...
			<div class="col-xs-1"> 
				<div class="sila">
					<h5>
						<a data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg-3" data-id="39" data-power="down"><img src="http://test.umperium.ru/assets/images/brain-minus.png" alt="">
						</a>
												<span class="power-count" style="color:#00a500">3</span>
						<a data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg-3" data-id="39" data-power="up"><img src="http://test.umperium.ru/assets/images/brain-plus.png" alt="">
						</a>
...
<?php Frontend_Post_Repost_Show_List($row['id'],10); ?>
