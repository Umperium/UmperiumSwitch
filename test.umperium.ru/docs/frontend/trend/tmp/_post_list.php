...
<?php echo $row['comment']; ?>
			...
			<div class="col-xs-1"> 
				<div class="sila">
					<h5>
						<a <?php if(isset($_SESSION['user'])) {?>href="#" class="power" <?php } else { ?>data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg-3"<?php } ?> data-id="<?php echo $row['id']; ?>" data-power="down"><img src="http://test.umperium.ru/assets/images/brain-minus.png"  alt="">
						</a>
						<?php $color = ''; 
						...
						<a <?php if(isset($_SESSION['user'])) {?>href="#" class="power" <?php } else { ?>data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg-3"<?php } ?> data-id="<?php echo $row['id']; ?>" data-power="up"><img src="http://test.umperium.ru/assets/images/brain-plus.png"  alt="">
						</a>
