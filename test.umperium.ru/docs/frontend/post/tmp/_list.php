    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <h4>
                        <a href="<?php echo $link; ?>" <?php if ($link == '') { ?> class="buy-btn" data-id="<?php echo $row['id']; ?>" data-price="<?php echo $price; ?>" data-toggle="modal" data-animation="bounce" data-target=".bs-buy" <?php } ?>><?php echo $row['name']; ?></a><?php echo $lock; ?>
                    </h4>
                    ...
                    <?php if ($row['repost_id'] != 0) {
                        Frontend_Post_Repost_Show($row['repost_id']);
                    } ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-1">
                    <div class="sila">
                        <h5>
                            <a data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg-3"
                               data-id="39" data-power="down"><img
                                        src="http://test.umperium.ru/assets/images/brain-minus.png" alt="">
                            </a>
                            <span class="power-count" style="color:#00a500">3</span>
                            <a data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg-3"
                               data-id="39" data-power="up"><img
                                        src="http://test.umperium.ru/assets/images/brain-plus.png" alt="">
                            </a>
