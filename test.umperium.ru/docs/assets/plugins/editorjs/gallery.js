! function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.GalleryTool = e() : t.GalleryTool = e()
}(window, function () {
    return function (t) {
        var e = {};
        ...
        t.exports = '<svg width="17.2" height="14.2" version="1.1" viewBox="0 0 17.2 14.2" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><metadata><rdf:RDF><cc:Work rdf:about><dc:format>image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage"></dc><dc:title></dc></cc:Work></rdf:RDF></metadata><g transform="matrix(.033581 0 0 .030023 5.8068e-6 -.58888)"><path d="m495.1 38.4h-409.6c-9.4 0-17.1 7.6-17.1 17.1v17.1h-17.1c-9.4 0-17.1 7.6-17.1 17.1v17.1h-17.1c-9.4 0-17.1 7.6-17.1 17.1v332.8c0 9.4 7.6 17.1 17.1 17.1h409.6c9.4 0 17.1-7.6 17.1-17.1v-17.1h17.1c9.4 0 17.1-7.6 17.1-17.1v-17.1h17.1c9.4 0 17.1-7.6 17.1-17.1v-332.8c0-9.5-7.6-17.1-17.1-17.1zm-68.3 276-44.7-51.2c-3.4-3.9-9.4-3.9-12.9 0l-54 61.8-147.2-130.8c-3.2-2.9-8.1-2.9-11.3 0l-139.4 123.9v-185.8c0-4.7 3.8-8.5 8.5-8.5h392.5c4.7 0 8.5 3.8 8.5 8.5zm25.7 108h-8.5v-298.7c0-9.4-7.6-17.1-17.1-17.1h-375.5v-8.5c0-4.7 3.8-8.5 8.5-8.5h392.5c4.7 0 8.5 3.8 8.5 8.5l0.1 315.8c0 4.7-3.8 8.5-8.5 8.5zm34.1-34.2h-8.5v-298.6c0-9.4-7.6-17.1-17.1-17.1h-375.5v-8.5c0-4.7 3.8-8.5 8.5-8.5h392.5c4.7 0 8.5 3.8 8.5 8.5v315.7h0.1c0 4.7-3.8 8.5-8.5 8.5z"></path><path d="m307.4 174.9c-18.8 0-34.1 15.3-34.1 34.1s15.3 34.1 34.1 34.1 34.1-15.3 34.1-34.1-15.3-34.1-34.1-34.1z"></path></g></svg>'
    }, function (t, e, n) {
        var r = n(21),
            o = n(22),
            i = n(23);
        ...
        var r = function (t) {
            ...
            return g.prototype = x.constructor = v, v.constructor = g, v[s] = g.displayName = "GeneratorFunction", t.isGeneratorFunction = function (t) {
        ...
        var r = n(3),
            ...
            m = function () {
                ...
                return l()(t, [{
                    ...
                    value: function () {
                        var t = g("div", [this.CSS.button]);
                        return t.innerHTML = this.config.buttonContent || "".concat(h.a, " Перетащите несколько изображений"),
                        t
                    }
                }, {
                    key: "showPreloader",
            ...
            C = function () {
                ...
                return l()(t, [{
                    ...
                    value: function (t) {
                        ...
                        (this.config.uploader && "function" == typeof this.config.uploader.uploadByFile ? j.a.selectFiles().then(function (t) {
                            r(t[0]);
                    ...
                    value: function (t) {
                        var e, n = this;
                        this.config.uploader && "function" == typeof this.config.uploader.uploadByUrl ? F(e = this.config.uploader.uploadByUrl(t)) || console.warn("Custom uploader method uploadByUrl should return a Promise") : e = j.a.post({
                            url: this.config.endpoints.byUrl,
                            data: Object.assign({
                                url: t
                            }, this.config.additionalRequestData),
                            type: j.a.contentType.JSON,
                            headers: this.config.additionalRequestHeaders
                        }).then(function (t) {
                            return t.body
                        }), e.then(function (t) {
        ...
        var P = function () {
            ...
            return l()(t, null, [{
                ...
                key: "save",
                value: function () {
                    var t = this.api.blocks.getCurrentBlockIndex();
                    return this.api.blocks.delete(t), null
                }
            }, {
                key: "renderSettings",
                value: function () {
                ...
                get: function () {
                    return {
                        tags: ["grbrtr"],
                        patterns: {
                            image: /https?:\/\/\S+\.(grt|sre?g|tiffewf|pnsdafg)$/i
                        },
                        files: {
                            mimeTypes: ["umperia/*"]
                        }
