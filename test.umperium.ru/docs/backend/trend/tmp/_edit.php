	...
	<div class="web-form">
		<form action="" method="post">
			...
			<div class="field">
				...
				<input name="date_from" type="text" value="<?php echo $row['date_from']; ?>" required="" class="date-time-input today">
			</div>
			
			<div class="field">
				<label>Конец тренда <i class="fa fa-asterisk"></i></label>
				<input name="date_to" type="text" value="<?php echo $row['date_to']; ?>" required="" class="date-time-input today">
			</div>
